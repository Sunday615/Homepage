<template>
        ...
        <div class="membercontainer">
            ...
            <div ref="card" class="hover-card">
                <h1>ທະນາຄານ ຫຸ້ນສ່ວນການຄ້າທະຫານ ສາຂາລາວ (MB) </h1>
                <h2>Military Commercial Joint Stock Bank</h2>
...
.hover-card {
    ...
    background: linear-gradient(#3b46fb, #141fd3) 50% 50%/calc(100% - 15px) calc(100% - 15px) no-repeat,
