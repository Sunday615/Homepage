<template>
  <div class="membercontainer">
    ...
    <div ref="card" class="hover-card">
      ...
      <h2>Banque Pour Le Commerce Exterieur Lao Public</h2>

      <div class="icons" ref="icons">
        <a v-if="link1" :href="link1" class="icon" target="_blank">
          <i class="fa-brands fa-facebook-f"></i>
        </a>
        <a v-if="link2" :href="link2" class="icon" target="_blank">
