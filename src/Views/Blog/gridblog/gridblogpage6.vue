        ...
        <div class="cardviewleftcontent">
                ...
                <div class="blogcardview">
                    <div class="imgbox">
                        <div class="image-container">
                            <img src="../../../../public/images/16/1.jpg" alt="Zoom Image" class="zoom-image" />
                        </div>
                        ...
                        <div class="allinfo">
                            ...
                            <div class="headerblog">
                                <h1>
                                    ເທດສະການສະຕາດອັບລາວ ບໍລິສັດ LAPNET ກໍໄດ້ຮັບກຽດໃຫ້ເຂົ້າຮ່ວມບັນຍາຍເພື່ອນຳສະເໜີກ່ຽວກັບ
                                    ບໍລິສັດ LAPNET
                                </h1>
                            </div>
                            <div class="btnblog">
            ...
            <router-link to="/blogdetail17">
                <div class="blogcardview">
                    <div class="imgbox">
                        <div class="image-container">
                            <img src="../../../../public/images/17/1.jpeg" alt="Zoom Image" class="zoom-image" />
                        </div>
                        ...
                        <div class="allinfo">
                            ...
                            <div class="headerblog">
                                <h1>
                                    ພິທີເຊັນສັນຍາແຕ່ງຕັ້ງທີ່ປຶກສາດ້ານການເງິນ ລະຫວ່າງ ບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ
                                    ເນັດເວີກ ຈຳກັດ ແລະ ບໍລິສັດ ຫຼັກຊັບ ລ້ານຊ້າງ ມະຫາຊົນ
                                </h1>
                            </div>
                            <div class="btnblog">
                                <button class="button-57" role="button"><span class="text">ອ່ານເພີ່ມເຕີ່ມ <i
            ...
            <router-link to="/blogdetail18">
                <div class="blogcardview">
                    <div class="imgbox">
                        <div class="image-container">
                            <img style="object-position: center;" src="../../../../public/images/18/1.jpg"
