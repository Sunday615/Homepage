...
<template>
        ...
        <div class="navigator-info-container">
            ...
            <div class="navigatorlink">
                ...
                ></span> ຜະລິດຕະພັນ ແລະ ການບໍລິການ
                        <span style="padding-right: 40px; padding-left: 40px"><i class="fa-solid fa-chevron-right"></i>
                </span> ກວດຍອດເງິນຂ້າມທະນາຄານຜ່ານຕູ້ ATM
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="conatinerproduct1-page1">
        <img id="bgproductpage1" src="../../assets/Products/product1/bgpd1-1.png" alt="" />
        <div class="containerframe1">
            <div class="leftcontentpage1">
                ...
                <div class="titleinfopage1">
                    <div>
                        <p>
                            ການກວດຍອດເງິນຂ້າມທະນາຄານຜ່ານຕູ້ ATM ແມ່ນນຳໃຊ້ລະບົບ<br />ແລັບໃນການເຊື່ອມໂຍງຕູ້ເອທີເອັມຂອງແຕ່ລະທະນາຄານທີ່ເປັນສະມາຊິກ<br />ຂອງບໍລິສັດລາວ ເນເຊີນນໍເພເມັ້ນ ເນັດເວີກ ໃຫ້ສາມາດໃຊ້ຟັງຊັ່ນການກວດ<br />ຍອດເງິນຂ້າມທະນາຄານໄດ້.
                        </p>
                    </div>
                </div>
            ...
            <div class="rightcontentpage1">
                <div data-aos="fade-left" data-aos-duration="1400">
                    <img id="topbg" src="../../assets/Products/product1/pd1bg.webp" alt="" />
                </div>
