    ...
    <div class="logo-box">
        ...
        <div class="logo">
            <div data-aos="fade-down" data-aos-duration="800">
                ...
                <div class="row1">
                    <div class="boxlogo1"><img style="width: 170px; height:110px;"
                            src="../../assets/Logomember- retangle/bcelretangle.png" alt=""></div>
                    <div class="boxlogo2">
                        <img style="width: 195px; " src="../../assets//Logomember- retangle/ldbwithborder.png"
                            alt="">
                    </div>
                    <div class="boxlogo3"><img style="width: 140px; height:140px"
                            src="../../assets/Logomember- retangle/apbpng.png" alt=""></div>
                    <div class="boxlogo4">
                        <img style="width: 190px;" src="../../assets/Logomember- retangle/jdb.png" alt="">
                    </div>
                    <div class="boxlogo5">
                        <img style="width: 180px; height:180px" src="../../assets/Logomember- retangle/MARU.jpg"
                            alt="">
                    </div>
                    <div class="boxlogo6">
            ...
            <div data-aos="fade-down" data-aos-duration="900" data-aos-delay="500">
                <div class="row1">
                    ...
                    <div class="boxlogo9">
                        <img style="width:190px ; padding-bottom: 30px;"
            ...
            <div data-aos="fade-down" data-aos-duration="1000" data-aos-delay="1000">
                <div class="row1">
                    <div class="boxlogo13">
                        <img style="width:190px" src="../../assets/Logomember- retangle/sacombankretangle.jpeg"
                            alt="">
                    </div>
                    <div class="boxlogo14">
