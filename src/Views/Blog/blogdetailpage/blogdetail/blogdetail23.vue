...
<template>
    ...
    <div class="container">
        ...
        <div class="left-blog-container">
            ...
            <div class="aboutblog">
                <span>
                    <p><i class="fa-solid fa-calendar"></i> 22 October 2020</p>
                </span>
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true">
                    <div class="box-background">
                        ...
                        <div class="titleheader">
                            <h1>ກິດຈະກຳກິລາບານເຕະມິດຕະພາບ ລະຫວ່າງບໍລິສັດ LAPNET ຮ່ວມກັບ ກົມຄຸ້ມຄອງລະບົບຊຳລະສະສາງ.</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="descriptionline1">
                <p>    ໃນວັນທີ 22 ຕຸລາ 2020 ທີ່ຜ່ານມາ ທີ່ເດີ່ນເຕະບານ ຫຍ້າທຽມ Victory, ນະຄອນຫຼວງວຽງຈັນ ໄດ້ມີກິດຈະກຳບານເຕະມິດຕະພາບ ລະຫວ່າງ ບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ (LAPNet) ແລະ  ກົມຄຸ້ມຄອງລະບົບຊຳລະສະສາງ (Payment Systems Department).
                </p>
                <p>    ເພື່ອເປັນການຮັດແໜ້ນຄວາມສາມັກຄີ, ແລກປ່ຽນສາຍສຳພັນ ແລະ ເສີມສ້າງສາຍສຳພັນ ລະຫວ່າງພະນັກງານທັງ 2 ພາກສ່ວນ.
                </p>
