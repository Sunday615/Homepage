    ...
    <div class="container">
        ...
        <div class="left-blog-container">
            <div class="blogdetailimg">
                <img src="../../../../../public/images/27/27.1.jpg" alt="">
            </div>
            <div class="aboutblog">
                <span>
                    <p><i class="fa-solid fa-calendar"></i> 25 November 2019</p>
                </span>
                <span class="padding-icon">
                    <p><i class="fa-solid fa-bookmark"></i> Grand Openning</p>
                </span>
                <span class="padding-icon">
                    <p><i class="fa-solid fa-eye"></i> ໂພສເມື່ອ 6 Year ago</p>
                </span>
            </div>
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true">
                    <div class="box-background">
                        ...
                        <div class="titleheader">
                            <h1>ພິທີເປີດບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ.</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="descriptionline1">
                <p>    ພິທີເປີດບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ ຢ່າງເປັນທາງການ ແລະ ເປີດໂຕການບໍລິການໂອນເງິນຂ້າມທະນາຄານ ໂດຍຜ່ານຕູ້ ATM.
                </p>
                ...
                <p>    ໂດຍຈຸດປະສົງການດຳເນີນທຸລະກິດຂອງບໍລິສັດ ແມ່ນເຮັດໜ້າທີ່ຄວບຄຸມລະບົບຊຳລະທຸລະກຳຍ່ອຍ ໃນ ສປປ ລາວ ຕາມຄຳຂວັນຂອງບໍລິສັດ ທີ່ວ່າ: “ທຸກທີ່, ທຸກເວລາ ແລະ ທຸກເຄື່ອງມືການຊຳລະ (Any Time, Any Where and Any Payment Channel)” ສອດຄ່ອງກັບລະດັບຄາດໝາຍທີ່ໄດ້ວາງໄວ້ໃນແຜນຍຸດທະສາດພັດທະນາລະບົບສະຖາບັນການເງິນ-ເງິນຕາ ຂອງ ສປປ ລາວ ໄລຍະ 10 ປີ (2016-2025) ແລະ ຕາມວິໄສທັດຮອດປີ 2030.
                </p>
                <p>    ປະຈຸບັນ ບໍລິສັດ LAPNet ໄດ້ມີ ສະມາຊິກທັງໝົດ 12 ທະນາຄານ ທີ່ສາມາດເຮັດທຸລະກຳ ຄື: ກວດຍອດເງິນໃນບັນຊີ, ຖອນເງິນສົດ ຜ່ານຕູ້ເອທີເອັມຮ່ວມກັນໄດ້ແລ້ວ ທົ່ວປະເທດ ອັນໄດ້ແກ່: ທະນາຄານການຄ້າຕ່າງປະເທດລາວ, ທະນາຄານພັດທະນາລາວ, ທະນາຄານສົ່ງເສີມກະສິກຳ, ທະນາຄານຮ່ວມທຸລະກິດລາວ-ຫວຽດ, ທະນາຄານຮ່ວມພັດທະນາ, ທະນາຄານ ມາຣູຮານ ເຈແປນ ລາວ ຈຳກັດ, ທະນາຄານ ຫວຽດຕິນ ລາວ, ທະນາຄານອຸດສາຫະກຳ ແລະ ການຄ້າຈີນ, ທະນາຄານແຫ່ງ ປະເທດຈີນ, ທະນາຄານເອຊີລີດາລາວ, ທະນາຄານ ອິນໂດຈີນລາວ ແລະ ທະນາຄານ ບີໄອຊີລາວ ຈຳກັດ.
                </p>
                <p>    - ປະຈຸບັນ ບໍລິສັດກຳລັງລິເລີ່ມໂຄງການໂອນເງິນເງິນຂ້າມທະນາຄານ ໂດຍຜ່ານຕູ້ເອທີເອັມ ຊຶ່ງຕອນນີ້ໄດ້ມີ 6 ທະນາຄານທີ່ເປັນສະມາຊິກ ສາມາດພັດທະນາລະບົບຂອງຕົນສຳເລັດ ຊຶ່ງຈະເປີດໃຫ້ນຳໃຊ້ໄດ້ບາງຈຸດ ແລະ ສາມາດນຳໃຊ້ໄດ້ທຸກຕູ້ພາຍໃນທ້າຍປີ 2019 ນີ້:
                </p>
                <p>    - ຊຶ່ງໃນຕໍ່ໜ້າບໍລິສັດ ຈະພະຍາຍາມພັດທະນາລະບົບທີ່ສາມາດຊຳລະຄ່າສິນຄ້າ ແລະ ຄ່າບໍລິການຕ່າງໆຢູ່ຮ້ານຄ້າໂດຍຜ່ານເຄື່ອງພີໂອເອສ,ຜ່ານ QR Code ຂອງທະນາຄານທຸລະກິດອື່ນທີ່ເປັນສະມາຊິກຂອງບໍລິສັດ LAPNet ໄດ້.
                </p>
            ...
            <div data-aos="zoom-out-up" data-aos-duration="500" data-aos-once="true">
                <div class="imageinfo">
                    <img src="../../../../../public/images/27/27.2.jpeg" alt="">
                    <img src="../../../../../public/images/27/27.3.jpeg" alt="">
                    <img src="../../../../../public/images/27/27.4.jpeg" alt="">
                    <img src="../../../../../public/images/27/27.5.jpeg" alt="">
                    <img src="../../../../../public/images/27/27.6.jpeg" alt="">
                    <img src="../../../../../public/images/27/27.7.jpeg" alt="">
                    <img src="../../../../../public/images/27/27.8.jpeg" alt="">
                    <img src="../../../../../public/images/27/27.9.jpeg" alt="">
