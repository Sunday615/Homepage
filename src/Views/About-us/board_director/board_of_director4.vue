...
<template>
        ...
        <div class="navigator-info-container">
            ...
            <div class="navigatorlink">
                ...
                <p>ໜ້າຫຼັກ <span style="padding-right: 40px; padding-left: 40px;"><i
                    ...
                    </span> ຄະນະສະພາຜູ້ບໍລິຫານ<i class="fa-solid fa-chevron-right" style="padding-left: 40px; padding-right: 40px;"></i> ຄະນະກຳມະການຕິດຕາມການພັດທະນາລະບົບ </p></div>
            </div>
        </div>
    </div>
    ...
    <div class="boardofdirectorimg">
        ...
        <img src="../../../assets/Aboutus/Board_of_director/develop.png" alt=""></div>
    </div>
