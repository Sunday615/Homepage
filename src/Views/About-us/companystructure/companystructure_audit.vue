...
<template>
            ...
            <div class="navigatorlink">
                <div data-aos="zoom-out-up" data-aos-duration="1000">
                    <p>ໜ້າຫຼັກ <span style="padding-right: 40px; padding-left: 40px;"><i
                        ...
                        </span> ໂຄງຮ່າງການຈັດຕັ້ງ <i class="fa-solid fa-chevron-right" style="padding-left: 40px; padding-right: 40px;"></i> ພະແນກກວດສອບພາຍໃນ </p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="companystructure">
        ...
        <img src="../../../assets/Aboutus/Company/Audit.png" alt=""></div>
    </div>
