    ...
    <div class="container">
        ...
        <div class="left-blog-container">
            <div class="blogdetailimg">
                <img src="../../../../../public/images/19/1.png" alt="">
            </div>
            <div class="aboutblog">
                <span>
                    <p><i class="fa-solid fa-calendar"></i> 17 June 2021</p>
                </span>
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true">
                    <div class="box-background">
                        ...
                        <div class="titleheader">
                            <h1>ລາຍຊື່ ຜູ້ຄວບຄຸມລະບົບການຊໍາລະທຸລະກຳຍ່ອຍ ຜູ້ໃຫ້ບໍລິການຊໍາລະ ທີ່ໄດ້ຮັບອະນຸຍາດ ຈາກ ທະນາຄານແຫ່ງ ສປປ ລາວ.</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="descriptionline1">
                <p>    ທະນາຄານແຫ່ງ ສປປ ລາວ ໄດ້ອອກແຈ້ງການ ກ່ຽວກັບ ລາຍຊື່ ຜູ້ຄວບຄຸມລະບົບການຊໍາລະທຸລະກຳຍ່ອຍ ຜູ້ໃຫ້ບໍລິການຊໍາລະ ທີ່ໄດ້ຮັບອະນຸຍາດ ຈາກ ທະນາຄານແຫ່ງ ສປປ ລາວ.
                </p>
