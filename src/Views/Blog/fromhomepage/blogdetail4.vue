...
<template>
    ...
    <div class="container">
        ...
        <div class="left-blog-container">
            ...
            <div class="aboutblog">
                <span>
                    <p><i class="fa-solid fa-calendar"></i> 03 April 2024</p>
                </span>
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true">
                    <div class="box-background">
                        ...
                        <div class="titleheader">
                            <h1>ພິທີເປີດໂຕການນຳໃຊ້ລະບົບຊຳລະຂ້າມແດນໃນຮູບແບບ QR CODE ລະຫວ່າງ ລາວ - ໄທ.</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="descriptionline1">
                <p>            ໃນວັນທີ 03 ເມສາ 2024 ໄດ້ມີພິທີເປີດໂຕການນຳໃຊ້ລະບົບຊຳລະຂ້າມແດນໃນຮູບແບບ QR Code ລະຫວ່າງ ລາວ - ໄທ ຂຶ້ນຢ່າງເປັນທາງການ ທີ່ ນະຄອນຫຼວງພະບາງ, ແຂວງຫຼວງພະບາງ. ໂດຍໂຄງການດັ່ງກ່າວເປັນການຮ່ວມມືກັນລະຫວ່າງ ບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ (LAPNet) ແລະ ບໍລິສັດ National ITMX ຈຳກັດ (NITMX). 
                </p>
                <p>
    ...
    <div class="paddingbox" style="width: 100%;
    height:200px"></div>
