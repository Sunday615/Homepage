...
<template>
    ...
    <div class="backbtn">
        <router-link to="/page/10"><button style="cursor:pointer;"><i class="fa-solid fa-angle-left" style=""></i>
    ...
    <div class="container">
        ...
        <div class="left-blog-container">
            <div class="blogdetailimg">
                <img src="../../../../../public/images/28/28.1.jpeg" alt="">
            </div>
            <div class="aboutblog">
                <span>
                    <p><i class="fa-solid fa-calendar"></i> 22 November 2019</p>
                </span>
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true">
                    <div class="box-background">
                        ...
                        <div class="titleheader">
                            <h1>ພິທີລົງນາມໃນສັນຍາການຮ່ວມທຶນຂອງ ບໍລິສັດ ລາວ ເນເຊິນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ.</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="descriptionline1">
                <p>    ບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ ຫຼື LAPNet (Lao National Payment Network)
                    ໄດ້ຈັດພິທີລົງນາມໃນສັນຍາການຮ່ວມທຶນ ຂອງບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ ໃນຕອນເຊົ້າວັນທີ
                    22/11/2019, ທີ່ໂຮງແຮມ ຄຣາວ ພລາຊ່າ ໂດຍການໃຫ້ກຽດເຂົ້າຮ່ວມຂອງ ທ່ານ ສອນໄຊ ສິດພະໄຊ ຜູ້ວ່າການທະນາຄານແຫ່ງ
                    ສປປ ລາວ, ຕາງໜ້າຈາກກະຊວງອຸດສາຫະກຳ ແລະ ການຄ້າ ແລະ ບັນດາທະນາຄານຕາງໜ້າຈາກຜູ້ຖືຮຸ້ນ 9 ຝ່າຍ ທັງພາຍໃນ ແລະ
                    ຕ່າງປະເທດ ພ້ອມທັງການເຂົ້າຮ່ວມເປັນສັກຂີພະຍານຂອງຕາງໜ້າຈາກບັນດາທະນາຄານທຸລະກິດ ພາຍໃນ ສປປ ລາວ.
                </p>
                <p>    ບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ ໄດ້ສ້າງຕັ້ງຂຶ້ນພາຍໃຕ້ການຮ່ວມມື ຂອງ 9 ຜູ້ຖືຮຸ້ນ
                    ອັນໄດ້ແກ່: ທະນາຄານ ແຫ່ງ ສປປ ລາວ, ທະນາຄານການຄ້າຕ່າງປະເທດລາວ ມະຫາຊົນ, ບໍລິສັດ ຢູນຽນເພ ສາກົນ,
                    ທະນາຄານພັດທະນາລາວ, ທະນາຄານສົ່ງເສີມກະສິກຳ, ທະນາຄານຮ່ວມພັດທະນາ, ທະນາຄານຮ່ວມທຸລະກິດລາວ-ຫວຽດ,
                    ທະນາຄານເອັສທີ ຈຳກັດ ແລະ ທະນາຄານ ບີໄອຊີ ລາວ ຈຳກັດ.
            ...
            <div data-aos="zoom-out-up" data-aos-duration="500" data-aos-once="true">
                <div class="imageinfo">
                    <img src="../../../../../public/images/28/28.2.jpeg" alt="">
                    <img src="../../../../../public/images/28/28.3.jpeg" alt="">
