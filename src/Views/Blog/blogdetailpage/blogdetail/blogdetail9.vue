...
<template>
    ...
    <div class="container">
        ...
        <div class="left-blog-container">
            ...
            <div class="aboutblog">
                <span>
                    <p><i class="fa-solid fa-calendar"></i> 22 August 2023</p>
                </span>
                ...
                <div data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true">
                    <div class="box-background">
                        ...
                        <div class="titleheader">
                            <h1> ເດີນທາງໄປແລກປ່ຽນບົດຮຽນຮ່ວມກັບ ທະນາຄານແຫ່ງລັດຫວຽດນາມ, ບໍລິສັດ ຫຸ້ນສ່ວນຊໍາລະແຫ່ງຊາດຫວຽດນາມ (NATIONAL PAYMENT CORPORATION OF VIETNAM ຫຼື NAPAS).</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="descriptionline1">
                <p >    ໃນລະຫວ່າງວັນທີ 22-26 ສິງຫາ 2023, ທ່ານ ມະໂນລິດ ຊຸມພົນພັກດີ, ປະທານສະພາບໍລິຫານ ແລະ ທ່ານ ສີສະໝອນ ສຣິດທິຣາດ, ຜູ້ອຳນວຍການບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ (LAPNet) ໄດ້ນຳພາຄະນະຈາກບໍລິສັດເດີນທາງໄປແລກປ່ຽນບົດຮຽນຮ່ວມກັບ ທະນາຄານແຫ່ງລັດຫວຽດນາມ, ບໍລິສັດ ຫຸ້ນສ່ວນຊໍາລະແຫ່ງຊາດຫວຽດນາມ (National Payment Corporation of Vietnam ຫຼື NAPAS), ທະນາຄານ Joint Stock Commercial Bank for Investment and Development of Vietnam (BIDV) ແລະ ທະນາຄານ VietinBank Vietnam.
                </p>
                <p >    -------------------------------------------------------------------------- 
                </p>
                <p >    ໃນການໄປແລກປ່ຽນບົດຮຽນໃນຄັ້ງນີ້ແມ່ນເພື່ອ ກະກຽມຄວາມພ້ອມໃນການເປີດໃຫ້ບໍລິການລະບົບເຊື່ອມໂຍງລະບົບຊຳລະຜ່ານ QR Code ລະຫວ່າງ ສປປ ລາວ ແລະ ສສ ຫວຽດນາມ ທີ່ຈະເປີດໃຫ້ບໍລິການໃນໄວໆນີ້.
                </p>
            ...
            <div data-aos="zoom-out-up" data-aos-duration="500" data-aos-once="true">
                <div class="imageinfo">
                    ...
                    <img src="../../../../../public/images/9/6.jpg" alt="">
