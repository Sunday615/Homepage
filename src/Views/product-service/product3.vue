...
<template>
  ...
  <div class="conatinerproduct1-page1">
    <img id="bgproductpage1" src="/product3/bgtempleteproduct3-1.png" alt="" />
    <div class="containerframe1">
      ...
      <div class="rightcontentpage1">
        <div data-aos-duration="1400" data-aos="fade-left">
          <img
            id="topbg"
            src="/product3/alexandros-giannakakis-Pl9feRmi3qE-unsplash.jpg"
            alt=""
          />
        </div>
        <div data-aos="zoom-in" data-aos-duration="1200">
          <img id="atmmachine" src="/product3/ATMpd3.webp" alt="" />
        </div>
      </div>
    </div>
  </div>
