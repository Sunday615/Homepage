    ...
    <div class="containerframe1">
      <div class="leftcontentpage1">
        ...
        <div class="headerproductpage1">
          <p>
            ຊຳລະເງິນຂ້າມແດນໃນຮູບແບບ<br />
            QR Code ລະຫວ່າງປະເທດ
          </p>
        </div>
        <div class="titleinfopage1">
          <p>
            ບໍລິສັດ LAPNet ໄດ້ຕໍ່ຍອດການພັດທະນາລະບົບຊຳລະຂ້າມທະນາຄານເທິງມືຖື<br />
            (LMPS) ເພື່ອຂະຫຍາຍຜະລິດຕະພັນ ຊຳລະຂ້າມທະນາຄານ ໃຫ້ສາມາດຮອງຮັບການ<br />
            ຊຳລະ ຄ່າສິນຄ້າ - ບໍລິການ ລະຫວ່າງປະເທດ, ໂດຍຜູ້ໃຊ້ Mobile banking ຂອງ<br />
            ທະນາຄານທີ່ເຂົ້າຮ່ວມໂຄງການ ໃນ ສປປ ລາວ ສາມາດເຮັດທຸລະກຳ ຊຳລະຂ້າມແດນໄປຍັງປະເທດທີ່ເຮັດການເຊື່ອມໂຍງລະບົບຊຳລະຂ້າມແດນ
